...
### Demo Input – User Tags & Story Snippet
This screenshot shows how users provide **comma-separated tags** and a **story snippet** in the Streamlit demo.

![Demo Input](screenshots/demo_input.png)

---

### Classification Result – Taxonomy Mapping Output
This screenshot shows the **mapped taxonomy leaf**, **hierarchy path**, **confidence score**, and **reasoning log** generated by the system.
